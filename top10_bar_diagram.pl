...
#qw(crimson blue lightseagreen orange mediumpurple palegreen lightcoral dodgerblue lawngreen red olive yellow fuchsia salmon mediumslateblue darkviolet purple sienna tan chocolate skyblue turquoise cadetblue green);
